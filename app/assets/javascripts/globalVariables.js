...
letterPairs = ["1","2","3","4","5","6","7","8","9","0","-","=",
               "Q","W","E","R","T","Y","U","I","O","P","[","]",
               "A","S","D","F","G","H","J","K","L",";","'","\\n",
               "Z","X","C","V","B","N","M",",",".","/","\\s","|"];
            
// for firefox
backupPairs = [49,50,51,52,53,54,55,56,57,48,173,61,
               81,87,69,82,84,89,85,73,79,80,219,221,
...
pressure1 = [4,5,6,7,8,9,33,34,41];
...
areas2 = [[0,1,2,3,4,12,15,16,24,26,27,28,37,38,39,40]];

sound3Srcs = ["a0", "e2", "a1","a3", "d0", "d1","d2", "d3", "b0", "b1", "b2", "b3",
